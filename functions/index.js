...
const serviceAccount = require('./zsemlyabc-firebase-adminsdk-yl5wf-14a46628c1.json');
admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: "https://zsemlyabc-default-rtdb.europe-west1.firebasedatabase.app"
});
